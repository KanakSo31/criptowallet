    ...
    <article>
        ...
        <div class="container">
          ...
          <div class="hero-banner">
            <figure class="hero-banner">
              <img src="./assets/images/cyberhornet.gif" width="799" height="823" alt="hero banner" class="w-100">
            </figure>
          </div>
            ...
            <ul class="stats-list">
              ...
              <li>
                <div class="stats-card bg-gray">
                  <h3 class="counter h3 card-title">150000</h3>
                  <h3 class="h2">+</h3>
              ...
              <li>
                <div class="stats-card bg-gray">
                  <h3 class="counter h3 card-title">45000</h3>
                  <h3 class="h2">+</h3>
                  <p class="card-text">Pepole Joined</p>
              ...
              <li>
                <div class="stats-card bg-gray">
                  <h3 class="counter h3 card-title">16000</h3>
                  <h3 class="h2">+</h3>
                  <p class="card-text">Investors Daily</p>
                </div>
              </li>
      ...
      <section class="section market" aria-label="crypto market live price">
        <div class="container">
          ...
          <h2 class="h2 section-title text-center">Raising Winzo Price Chart</h2>

          <p class="section-text text-center">The Whole Worl Is Watching And Investing With Raising Winnzo Why not You Are Joining With Join Today And Win Exciting Prices</p>
...
<!-- 
      ...
      <section class="stats" aria-label="statistics">
        <div class="container">
          ...
          <figure class="stats-banner">
            <img src="./assets/images/ss.gif" width="797" height="454" alt="map" class="w-100">
          </figure>
      ...
      <section class="section cta bg-gray" aria-label="call to action">
        <div class="container">
          ...
          <h2 class="h2 section-title text-center">Start Trading on Raising WINZO</h2>

          <p class="section-text text-center">
            If youre Still Have the fear of Fraud and fear of investing Trade Come with Us We Will Teach You The Raising Sun Technology To Grow With WINZO
          </p>
      ...
      <section class="section instruction" aria-label="instruction">
        <div class="container">
          ...
          <h2 class="h2 section-title text-center">How All it Work</h2>
          ...
          <ul class="grid-list">
            ...
            <li>
              <div class="instruction-card bg-gray">
                ...
                <p class="card-text">
                  Process of the working steps will display here with a deep details.
                </p>
    ...
    <div class="footer-top section">
      <div class="container">
        ...
        <div class="footer-brand">
          ...
          <p class="footer-text">Raising Winzo Is Offering service from past few decade and many people are raising from us so we are trustworthy and valuable ssets to you.</p>

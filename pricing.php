...
<body>
    ...
    <main>
        <article>
            <!--  #INSTRUCTION-->
            <section class="section instruction" aria-label="instruction" style="margin: 45px;">
                <div class="container">

                    <h2 class="h2 section-title text-center">RIZING WINZO SPECIAL Featured Upgrade Plan</h2>

                    <h4 class="section-text text-center">There Are Several services We Offer But Some Of among them Are</h4>
                    ...
                    <ul class="grid-list">
                        ...
                        <li>
                            <div class="instruction-card bg-gray">
                                ...
                                <div class="card-icon" style="display:flex; justify-content: center;">
                                    <img src="./assets/images/instruction-icon-1.svg" width="20" height="20"
                                        loading="lazy" alt="icon">
                                </div>
                                <h2>STARTTER PLAN</h2>

                                <p class="card-text">
                                    Details of a Investment plan will be display here including tax cut and the margin of investment and selection of plan will be Display here.
                                </p>
                                 <a href="#" class="btn btn-primary" style="margin-top: 5px;">Join Today</a>
                        ...
                        <li>
                            <div class="instruction-card bg-gray">
                                ...
                                <div class="card-icon">
                                    <img src="./assets/images/instruction-icon-2.svg" width="20" height="20"
                                        loading="lazy" alt="icon">
                                </div>
                                <h2>BASIC PLAN</h2>
                        ...
                        <li>
                            <div class="instruction-card bg-initial">

                                <div class="card-icon">
                                    <img src="./assets/images/instruction-icon-3.svg" width="20" height="20"
                                        loading="lazy" alt="icon">
                                </div>
                                <h2>INTERMIDIATE PLAN</h2>
                        ...
                        <li>
                            <div class="instruction-card bg-intermidiate">

                                <div class="card-icon">
                                    <img src="./assets/images/instruction-icon-4.svg" width="20" height="20"
                                        loading="lazy" alt="icon">
                                </div>
                                <h2>PRO PLAN</h2>
                        ...
                        <li>
                            <div class="instruction-card bg-pro">
                        ...
                        <li>
                            <div class="instruction-card bg-pro-plus">
                        ...
                        <li>
                            <div class="instruction-card bg-advance">
                        ...
                        <li>
                            <div class="instruction-card bg-advance-plus">
